...
exports.getColorWithOpacity = void 0;
var HEX_OPACITY = [
...
var getColorWithOpacity = function (color, opacity) {
    var opacityIndex = Math.floor(opacity);
    if (opacityIndex < 0 || opacityIndex > 100) {
        return color;
    }
    var hexOpacity = HEX_OPACITY[opacityIndex];
    return "".concat(color).concat(hexOpacity);
};
exports.getColorWithOpacity = getColorWithOpacity;
//# sourceMappingURL=colorCodeWithOpacity.js.map